    ...
    : ReferenceableComponentDefinition
{
    ...
    /// </summary>
    [DataMember(Order = 3, Name = "parameters"), JsonPropertyOrder(3), JsonPropertyName("parameters"), YamlMember(Order = 3, Alias = "parameters")]
    ...
    /// </summary>
    [DataMember(Order = 4, Name = "bindings"), JsonPropertyOrder(4), JsonPropertyName("bindings"), YamlMember(Order = 4, Alias = "bindings")]
