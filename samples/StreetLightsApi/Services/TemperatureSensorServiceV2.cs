    ...
    : BackgroundService
{
    ...
    [Channel("temperature/changed"), ReceiveOperation("OnTemperatureChanged", "temperature/changed", Summary = "Inform about temperature changes captured by sensors"), Message(Name = "TemperatureChanged")]
